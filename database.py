...
class DatabaseManager:
    """Manages SQLite storage, query operations, and data exports."""
    ...
    def init_db(self):
        ...
        with self.get_connection() as conn:
            cursor = conn.cursor()
            # Channels metadata & progress tracker
            cursor.execute("""
    ...
    def save_character(
        ...
        """Inserts or updates a character record."""
        ...
        with self.get_connection() as conn:
            ...
            cursor.execute("""
                INSERT INTO characters (
                    ...
                    name, anime, rarity, event, image_path, image_filename,
        ...
        with self.get_connection() as conn:
            ...
            with open(output_path, "w", encoding="utf-8", newline="") as f:
                ...
                writer.writerow([
                    ...
                    "Image Filename", "Image Path", "Channel Title", "Message ID", "Scraped At"
                ])
                for row in rows:
